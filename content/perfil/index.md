  ...
  - block: markdown
    content:
      ...
      text: |-
        ...
        .perfil{position:relative;left:50%;transform:translateX(-50%);width:min(1180px,92vw);display:grid;grid-template-columns:560px minmax(0,1fr);gap:3rem;align-items:start;padding-top:0}
