  ...
  - block: markdown
    content:
      ...
      text: |-
        ...
        <p style="text-align:center"><a class="section-cta" href="https://www.youtube.com/@carlocosentino" target="_blank" rel="noopener">▶ Ir para o canal no YouTube</a></p>

        <div class="yt-grid" id="yt-videos" data-yt-channel="UCAFgy5Xv0HOnfrDhJpTyQmQ" data-yt-count="8" data-yt-pinned="CyM0klkzuFU::Pod Cast - Tudo Bem Calculado | Conversa com Dr. Carlo Cosentino">
          ...
          <a class="yt-card" href="https://www.youtube.com/watch?v=1DcdbcQWOAE" target="_blank" rel="noopener"><div class="yt-card__thumb"><img loading="lazy" src="https://i.ytimg.com/vi/1DcdbcQWOAE/hqdefault.jpg" alt=""><span class="yt-card__play"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg></span></div><div class="yt-card__title">Discriminação do trabalho dos transgêneros</div></a>
        </div>

        <p style="text-align:center;margin-top:1.6rem"><a class="more-link" href="https://www.youtube.com/@carlocosentino/videos" target="_blank" rel="noopener">Ver todos os vídeos no YouTube →</a></p>
    design:
      columns: '1'
---
