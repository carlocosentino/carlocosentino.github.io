---
title: 'Direito do Trabalho e Teoria Social Crítica'
date: 2024-05-19
type: landing
...
sections:
  - block: markdown
    content:
      ...
      text: |-
        <style>
        .gp{max-width:820px;margin:0 auto;padding-top:.5rem}
        .gp__kicker{text-align:center;font-size:.8rem;letter-spacing:.16em;text-transform:uppercase;color:#9db4cc;font-weight:700;margin:-.6rem 0 1.4rem}
        .gp__desc{color:#cdd2da;line-height:1.85;font-size:1.04rem;text-align:justify;text-justify:inter-word;hyphens:auto;margin:0 0 1.2rem}
        .gp__desc strong{color:#f3f4f6;font-weight:600}
        .gp__meta{color:#aeb6c2;font-size:.96rem;line-height:1.8;margin:1.4rem 0 0;padding-top:1.2rem;border-top:1px solid rgba(255,255,255,.09)}
        .gp__meta strong{color:#f3f4f6;font-weight:600}
        .gp__meta a{color:#9db4cc;text-decoration:none;border-bottom:1px solid rgba(157,180,204,.35)}
        .gp__meta a:hover{color:#e8e8ea}
        .gp__links{display:flex;flex-wrap:wrap;gap:.7rem;justify-content:center;margin-top:1.6rem}
        .gp__links a{display:inline-block;padding:.55rem 1.15rem;border:1px solid #2c3340;border-radius:10px;color:#e8e8ea;text-decoration:none;font-weight:600;font-size:.88rem;transition:background .2s}
        .gp__links a:hover{background:#161a22}
        .gp__projetos{max-width:820px;margin:2.8rem auto 0;padding-top:1.8rem;border-top:1px solid rgba(255,255,255,.09)}
        .gp__projetos h2{font-size:.82rem;letter-spacing:.14em;text-transform:uppercase;color:#9db4cc;font-weight:700;margin:0 0 1.6rem;text-align:center}
        .gp__proj{margin:0 0 1.8rem}
        .gp__proj h3{font-size:1.02rem;font-weight:700;color:#f3f4f6;line-height:1.4;margin:0 0 .55rem}
        .gp__proj p{color:#cdd2da;line-height:1.8;font-size:1rem;text-align:justify;text-justify:inter-word;hyphens:auto;margin:0}
        .gp__proj .coord{display:block;font-size:.85rem;color:#8a93a0;margin-top:.5rem}
        </style>
        <div class="gp">
          ...
          <div class="gp__social">
            ...
            <a href="https://www.youtube.com/@gpdireitodotrabalhoeteoria5136" target="_blank" rel="noopener" title="YouTube" aria-label="YouTube"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
            <a href="https://www.instagram.com/dttsc.ufpe/" target="_blank" rel="noopener" title="Instagram" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881z"/></svg></a>
            <a href="https://www.facebook.com/gpdireitodotrabalhoeteoriasocialcritica" target="_blank" rel="noopener" title="Facebook" aria-label="Facebook"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a>
            <a href="mailto:direitodotrabalhofdrufpe@gmail.com" title="E-mail" aria-label="E-mail"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></svg></a>
          </div>
        </div>
        <div class="gp__projetos">
        ...
        <p class="site-contato--form-title">Fale com o grupo de pesquisa</p>
        ...
        <label for="gp-nome">Seu nome</label>
        <input id="gp-nome" name="Nome" type="text" required>
        <label for="gp-email">Seu e-mail</label>
        <input id="gp-email" name="E-mail" type="email" required>
        <label for="gp-assunto">Assunto</label>
        <input id="gp-assunto" name="Assunto" type="text">
        <label for="gp-msg">Sua mensagem</label>
        <textarea id="gp-msg" name="Mensagem"></textarea>
